"""
Decision Tree Model Training Script with Grid Search

This script loads preprocessed data and trains a decision tree classifier
...
def train_decision_tree(X_train, y_train, X_valid, y_valid):
    """
    Train a decision tree classifier using GridSearchCV for hyperparameter optimization.
...
def main():
    """Main training pipeline with grid search optimization."""
    print("="*60)
    print("Decision Tree Training Pipeline with Grid Search")
    print("="*60)
    ...
    print("  2. Check minority classes (accidental/undetermined) F1 scores")
